...
| `npm run sample -- out.csv --profile tiny` | Génère un export **fictif** de test (profils : `lyon`, `regional`, `regional-outlier`, `tiny`, `minimal`, `single`, `foreign`, `international`, `corsica`, `roundtrips`, `huge`) |
